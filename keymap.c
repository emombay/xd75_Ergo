...
#define _GAME_ADJ 5 // game and adjust keys
 ...
 */
 ...
 [_NUM] = { 
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, TO(_GAME_ADJ) },
...
/* Keymap 5: Adjust
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * |Version | EPRM   |        |        |        |        | Bright-| WRKM   | Hue-   |        |        |        | AGnorm | AGswap | Wrkmn  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * |        |        |        |        |        |        | Bright+| QWRTY  | Hue+   |        |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * |        |        |        |        |        |        |        | Animat |        |        |        |        |        |        |        |
...
[_GAME_ADJ] = {
   ...
   { VRSN,    EPRM,      _______,  _______,  _______,  _______,       RGB_VAD, WRKMN,   RGB_HUD, _______,  _______,  _______,  AG_NORM,  AG_SWAP,  TO(_WORK) },
   ...
   { _______  ,_______,  _______,  _______,  _______,  _______,       _______ ,_______, _______, _______,  _______,  _______,  _______,  _______,  _______ },
   { _______  ,_______,  _______,  _______,  _______,  CTL_T(KC_SPC), _______ ,_______, _______, _______,  _______,  _______,  _______,  _______,  _______ }
